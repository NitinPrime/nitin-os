...
export function Hero() {
  return (
    <section className="relative isolate min-h-[100svh] overflow-hidden pt-14">
      <SystemGraph className="pointer-events-none absolute inset-0 h-full w-full opacity-50" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,#08090c_72%)]" />

      <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-center px-5 py-24 sm:px-8">
        ...
        <h1 className="mt-8 font-display text-[18vw] leading-[0.86] tracking-[-0.04em] text-ink sm:text-[12vw] lg:text-[9.5rem]">
          {profile.name}
        </h1>
