...
export const projects: Project[] = [
  ...
  },
  {
    ...
    approach:
      "Ship an observability platform with a Python SDK that emits agent runs into a dashboard: traces, cost and latency analytics, evaluations, and version regression checks — so you can inspect what an agent actually did.",
    architecture: [
      {
        id: "sdk",
        label: "Python SDK",
        detail: "Instrumentation for agent runs — traces and metrics out of the application path.",
      },
      {
        id: "ingest",
        label: "Ingest",
        detail: "Accepts run data for storage and later analysis.",
      },
      {
        id: "analytics",
        label: "Analytics",
        detail: "Cost, latency, evaluations, and version regression checks over historical runs.",
      },
      {
        id: "dashboard",
        label: "Dashboard",
        detail: "Live UI to inspect traces and compare agent behavior across versions.",
      },
    ],
    challenges: [
      "Making agent runs inspectable without drowning the dashboard in noise.",
      "Keeping cost and latency visible next to qualitative evaluations.",
    ],
    decisions: [
      "A Python SDK as the primary instrumentation surface.",
    ...
    stack: ["Python", "SDK", "Observability", "Evaluations"],
